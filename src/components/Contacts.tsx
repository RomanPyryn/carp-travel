        ...
        <div className="smOnly:space-y-6 mdOnly:grid mdOnly:grid-cols-2 mdOnly:mb-16 xl:flex xl:flex-col justify-between">
          <div className="space-y-6 xl:space-y-16  xl:mb-32">
            <div className="contacts-block justify-end">
              <div className="">
                <a href="tel:+380981234567" className="contacts-link">+38 (098) 12 34 567</a>
								<a href="tel:+380731234567" className="contacts-link">+38 (073) 12 34 567</a>
              </div>
              <p className="contacts-label">Phone number</p>
            </div>
            <div className="contacts-block justify-end">
              <div className="">
                <a href="mailto:support@carptravel.com" className="contacts-link">support@carptravel.com</a>
              </div>
              ...
              <div className="w-[100px]">
                <a href={'facebook.com'} className="contacts-link">facebook</a>
                <a href={'https://www.instagram.com/'} className="contacts-link">instagram</a>
                <a href={'https://www.youtube.com'} className="contacts-link">youtube</a>
                <a href={'https://www.tiktok.com/'} className="contacts-link">tiktok</a>
              </div>
